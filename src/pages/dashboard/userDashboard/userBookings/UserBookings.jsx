...
const UserBookings = () => {
    return (
        <div >
            ...
            <div>
                <h2 className="text-3xl text-primary font-semibold mb-2 pl-3 outline w-52 mt-5 ">Event Booking</h2>
          ...
          <div className="rounded-md shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:shadow-lg bg-white hover:bg-gray-100">
            <div className="rounded-t-md shadow-lg h-60 relative overflow-hidden ">
                <img src="https://www.futurarc.com/wp-content/uploads/2019/02/Happ_A-Green-lifestyle_NovDec2016-copycopy.jpg" alt="Art and Culture Festival" className="rounded-t-md h-full w-full object-cover transform transition-transform duration-500 hover:scale-110" />
            ...
            <div className="px-4 py-6">
                ...
                <h2 className="text-2xl mt-2 font-semibold text-secondary">Green Living Expo</h2>
            ...
            <div>
                <h2 className="text-3xl text-primary font-semibold mb-2 pl-3 outline w-56 mt-7">Ticket booking</h2>
